...
function Scene() {
  ...
  return (
    <>
      {/* Moving Spotlights for better lighting */}
      ...
      {/* 3D Computer Model */}
      <mesh>
        <primitive object={computer.scene} scale={0.75} position={[0, -3, -1.5]} rotation={[-0.01, -0.2, -0.1]} />
      </mesh>
...
function MovingSpot({ vec = new Vector3(), ...props }) {
  ...
  return <SpotLight castShadow ref={light} penumbra={1} distance={10} angle={0.4} intensity={3} attenuation={5} anglePower={4} {...props} />;
}
